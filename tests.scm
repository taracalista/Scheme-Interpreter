...
; *** Problem 7 ***
(lambda (tara calista) (- calista tara))
; expect (lambda (tara calista) (- calista tara))
...
(define w (lambda (w) (* w w)))
; expect w

; *** Problem 10 ***
env = create_global_frame()
formals, expressions = read_line("(x y z)"), read_line("(24 25 26)")
env.make_child_frame(formals, expressions)
; expect <{x: 24, y: 25, z: 26} -> <Global Frame>>

; *** Problem 11B ***
check_formals(read_line("(t a r)"))

check_formals(read_line("(t a r a)"))
;expect SchemeError
